...
webos_layers = [
('bitbake',                   -1, 'git://github.com/openembedded/bitbake.git',              'branch=1.32,commit=da85da9', ''),
...
('meta-ros2',                 38, 'git://github.com/lgsvl/meta-ros2.git',                   'branch=ros2pr,commit=16805b2',''),
('meta-webos',                40, 'git://github.com/webosose/meta-webosose.git',            'branch=master,commit=c3dbb38', ''),
...
('meta-webos-ros2',           52, 'ssh://gpro.lgsvl.com/webosose/meta-webosose',            '', ''),
]
